...
Route::group(['domain' => 'api.' . config('app.domain'), 'prefix' => '/lesson', 'namespace' => 'Modules\Lesson\Http\Controllers'], $routes);
Route::group(['domain' => config('app.domain'), 'prefix' => '/api/v3', 'namespace' => 'Modules\Lesson\Http\Controllers'], $routes);
