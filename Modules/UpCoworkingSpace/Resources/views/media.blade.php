...
@section('content')
    ...
    <div class="container-fluid" style="background: #ffffff">
        ...
        <br/>
        <p class="text-center">
            Nếu bạn cần thêm thông tin hay hình ảnh nào của Up,
            <br/>
            xin vui lòng liên hệ Marketing Manager của chúng tôi tại: <a style="color: #96d21f;" href="#" target="_blank">habm@up-co.vn</a>
        </p>
        <br/>
    </div>
