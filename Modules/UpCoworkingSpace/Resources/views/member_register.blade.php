...
@section('en-content')
    ...
    <div class="container text-center">
        <div>
            ...
            <p style="font-size: 16px">
                    A modern co-working space as in Silicon Valley for Vietnamese Startups
            </p>
            <br/>
            <a href="/en/book-a-tour" style="background-color: #96d21f;
            border-color: #96d21f;" class="m-auto btn btn-success">
                BOOK A TOUR
            </a>
            <div style="display: flex; padding: 20px 20px 10px 20px">
                <hr style="width: 50%">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card-profile">
                    ...
                    <div class="card-body">
                        <p class="card-title" style="font-size: 17px; font-weight: 600;margin-bottom: 0">CREATIVE SPACE</p>
                        <div class="info info-horizontal">
                            <div class="icon">
                                <i class="nc-icon nc-time-alarm"></i>
                            </div>
                            <div class="description">
                                <h4 class="info-title">OPEN 24/7</h4>
                                <p class="info-detail">Working whenever you want</p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            <div class="icon">
                            ...
                            <div class="description">
                                <h4 class="info-title">MEETING ROOM</h4>
                                <p class="info-detail">Meeting rooms with various sizes, 3D projector, TV 82 inch</p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            <div class="icon">
                            ...
                            <div class="description">
                                <h4 class="info-title">PHONE BOOTH
                                </h4>
                                <p class="info-detail">Talking on the phone without being disturbed</p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            <div class="icon">
                            ...
                            <div class="description">
                                <h4 class="info-title">PROFESSIONAL RECEIVING GUESTS AREA</h4>
                                <p class="info-detail">Professional space for you to meet partners and customers</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card-profile">
                    ...
                    <div class="card-body">
                        <p class="card-title" style="font-size: 17px; font-weight: 600;margin-bottom: 0">STRONG COMMUNITY</p>
                        <div class="info info-horizontal">
                            <div class="icon">
                                <i class="fa fa-users" aria-hidden="true"></i>
                            </div>
                            <div class="description">
                                <h4 class="info-title">
                                        START UP'S COMMUNITY</h4>
                                <p class="info-detail">Joining startup community with various fields</p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            <div class="icon">
                            ...
                            <div class="description">
                                ...
                                <p class="info-detail">Attending events for free and having opportunity to reach investors and ventures</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="info info-horizontal">
                            ...
                            <div class="description">
                                <h4 class="info-title">
                                    SUPER FAST WIFI</h4>
                                <p class="info-detail">Fast, strong, stable, secure</p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            <div class="icon">
                            ...
                            <div class="description">
                                <h4 class="info-title">CONVENIENT KITCHEN</h4>
                                <p class="info-detail">
                                        Fully equiped kitchen area with fridge, oven, microwave and food which is always ready to serve members
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="info info-horizontal">
                            ...
                            <div class="description">
                                ...
                                <p class="info-detail">Hot tea and coffee 24/7</p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            <div class="icon">
                            ...
                            <div class="description">
                                <h4 class="info-title">
                                        RESTING AREA WITH COMFORTABLE MATTRESS</h4>
                                <p class="info-detail">
                                        Relax after working time
                                </p>
                            </div>
                        </div>
                        <div class="info info-horizontal">
                            ...
                            <div class="description">
                                ...
                                <p class="info-detail">
                                    Always take care of you if you need a help
                                </p>
                            </div>
                        </div>
                    </div>
