        ...
        <div class="gdlr-page-title-container container">
            ...
            <div class="gdlr-reservation-field gdlr-resv-combobox " style="display:inline">
                ...
                <div class="gdlr-combobox-wrapper" style="display:inline">
                    <select name="gdlr-night" style="background: #b89f80;color: white;min-width: 150px;height: 40px;border: none!important;margin: 10px; font-size:14px; font-family:'Open Sans'; padding:10px">
                    <option value="1" selected="">Chọn cơ sở</option>
                ...
                <div class="gdlr-combobox-wrapper"  style="display:inline">
                    <select name="gdlr-night" style="background: #b89f80;color: white;min-width: 150px;height: 40px;border: none!important;margin: 10px; font-size:14px; font-family:'Open Sans'">
                        <option value="1" selected="">Chọn loại phòng</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                        <option value="5">5</option>
                                        ...
                                        <div class="gdlr-item gdlr-room-item gdlr-modern-room">
                                            <div class="gdlr-ux gdlr-modern-room-ux">
                                                ...
                                                <h3 class="gdlr-room-title"><a
                                                        href="http://demo.goodlayers.com/hotelmaster/dark/room/standard-room-one-king-bed/">{{$room->base->name}}: {{$room->name}}</a></h3><a
