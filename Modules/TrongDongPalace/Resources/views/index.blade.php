            ...
            <div class="with-sidebar-wrapper">
                <section id="content-section-1">
                    <div class="gdlr-full-size-wrapper gdlr-show-all"
                        ...
                        <div class="gdlr-master-slider-item gdlr-slider-item gdlr-item" style="margin-bottom: 0px;">
                            <!-- MasterSlider -->
                            <div id="P_MS5af7a204502cd" class="master-slider-parent ms-parent-id-2">


                                <!-- MasterSlider Main -->
                                <div id="MS5af7a204502cd" class="master-slider ms-skin-default">

                                    <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                        <img src="http://demo.goodlayers.com/hotelmaster/dark/wp-content/plugins/masterslider/public/assets/css/blank.gif"
                                             alt="" title=""
                                             data-src="http://www.marry.vn/wp-content/uploads/2014/04/02/Ritz_GrandCayman_00316_galleries_1280x7201.jpg"/>
                                        ...
                                        <div class="ms-layer  msp-cn-1-3" style="width:48px;height:2px;"
                                             data-duration="775" data-delay="525" data-ease="easeOutQuint"
                                             data-offset-x="0" data-offset-y="-61" data-origin="mc"
                                        ...
                                        <div class="ms-layer  msp-cn-1-4" style=""
                                             ...
                                             data-delay="1462" data-ease="easeOutQuint" data-offset-x="0"
                                             data-offset-y="90" data-origin="mc" data-position="normal">
                                            Trung tâm tổ chức tiệc lớn nhất miền Bắc
                                        </div>
                                    ...
                                    <div class="ms-slide" data-delay="3" data-fill-mode="fill">
                                        <img src="http://demo.goodlayers.com/hotelmaster/dark/wp-content/plugins/masterslider/public/assets/css/blank.gif"
                                             alt="" title=""
                                             data-src="http://demo.goodlayers.com/hotelmaster/dark/wp-content/uploads/2015/04/slider-31.jpg"/>
                                        ...
                                        <div class="ms-layer  msp-cn-1-6" style="" data-duration="937" data-delay="525"
                                             data-ease="easeOutQuint" data-offset-x="33" data-offset-y="102"
                                             data-origin="ml" data-position="normal">
                                            Spa Master
                                        </div>

                                        <div class="ms-layer  msp-cn-1-7" style="" data-duration="975" data-delay="1137"
                                             data-ease="easeOutQuint" data-offset-x="176" data-offset-y="176"
                                             data-origin="ml" data-position="normal">
                                            The Finest Spa On Earth
                                        </div>
                                    ...
                                    <div class="ms-slide" data-delay="3" data-fill-mode="fill">
                                        <img src="http://demo.goodlayers.com/hotelmaster/dark/wp-content/plugins/masterslider/public/assets/css/blank.gif"
                                             alt="" title=""
                                             data-src="http://demo.goodlayers.com/hotelmaster/dark/wp-content/uploads/2015/04/slider-21.jpg"/>
                            ...
                            <script>
                                ( window.MSReady = window.MSReady || [] ).push(function ($) {
                                    ...
                                    // slider controls
                                    masterslider_02cd.control('arrows', {autohide: true, overVideo: true});
                                    masterslider_02cd.control('bullets', {
                                        autohide: false,
                                        overVideo: true,
                                        dir: 'h',
                                        align: 'bottom',
                                    ...
                                    // slider setup
                                    masterslider_02cd.setup("MS5af7a204502cd", {
                                        width: 1140,
                                        height: 530,
                                        minHeight: 0,
                                        space: 0,
                                    ...
                                    MSScrollParallax.setup(masterslider_02cd, 30, 50, true);
                ...
                <section id="content-section-4">
                    <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all gdlr-skin-light-grey"
                         ...
                         style="background-image: url('http://demo.goodlayers.com/hotelmaster/dark/wp-content/uploads/2015/03/room-bg.jpg'); padding-top: 80px; padding-bottom: 10px; ">
                        <div class="container">
    ...
    <footer class="footer-wrapper">
        <div class="footer-container container">
            <div class="footer-column three columns" id="footer-widget-1">
                <div id="text-5" class="widget widget_text gdlr-item gdlr-widget"><h3 class="gdlr-widget-title">Liên hệ ngay</h3>
                    <div class="clear"></div>
            ...
            <div class="footer-column six columns" id="footer-widget-3">
                <div id="text-10" class="widget widget_text gdlr-item gdlr-widget"><h3 class="gdlr-widget-title">Về chúng tôi</h3>
                    <div class="clear"></div>
...
<!-- Cached page generated by WP-Super-Cache on 2018-05-13 02:25:08 -->
