    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="btn btn-round btn-danger" style="background-color:#FF6D00;border-color:#FF6D00" href="/order"><i class="fa fa-shopping-cart"></i> Đăng kí </a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="http://d1j8r0kxyu9tj8.cloudfront.net/files/1510991940vLVQbFilsj4Puq7.png" height="60px"/>
            </div>
