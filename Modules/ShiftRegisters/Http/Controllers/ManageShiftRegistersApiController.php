            ...
            "shift_picks" => $shift_picks->map(function ($shiftPick) {
                $shiftPickDate = [
                    'shift_pick' => [
                        ...
                        'name' => $shiftPick->shift->shift_session ? $shiftPick->shift->shift_session->name : '',
                        'start_time' => $shiftPick->shift->shift_session ? $shiftPick->shift->shift_session->start_time : '',
                        'end_time' => $shiftPick->shift->shift_session ? $shiftPick->shift->shift_session->end_time : '',
