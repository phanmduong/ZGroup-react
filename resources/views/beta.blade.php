...
{{--<link rel="stylesheet" href="http://d1j8r0kxyu9tj8.cloudfront.net/colorme-react/styles.css">--}}
...
<!-- Froala Editor -->
    ...
    <link rel="stylesheet" href="{{url('colorme-react/styles.css')}}?66668888">
</head>
<body>
<div id="fb-root"></div>
...
{{--<script src="http://d1j8r0kxyu9tj8.cloudfront.net/colorme-react/bundle.js"></script>--}}
...
<script src="{{url('colorme-react/bundle.js')}}?66668888"></script>
<!-- Facebook Pixel Code -->
<script>
    ...
    fbq('init', '1696864077261774'); // Insert your pixel ID here.
    fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
               src="https://www.facebook.com/tr?id=1696864077261774&ev=PageView&noscript=1"
    /></noscript>
<!-- DO NOT MODIFY -->
