                            ...
                            <tr>
                                <td class="mobile-no-radius" style="background-color:#ffffff; border-radius: 15px;">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="header-image"
                                                     src="http://trongdongpalace.com/ckfinder/userfiles/images/Canh%20Ho-01(2).jpg"
                                                ...
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr style="text-align: center;vertical-align: middle;">
                                                        <td style="text-align: center">
                                                            <img src="http://d1j8r0kxyu9tj8.cloudfront.net/files/15178194240r275OBuC88NDYV.png"
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tbody>
                                        <tr>
                                            <td style="padding-top: 40px; padding-bottom: 30px; padding-right: 30px; padding-left: 30px;">
                                        <tbody>
