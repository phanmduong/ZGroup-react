                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left"
                                    style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">
                                    <a href="http://colorme.vn/resource/{{convert_vi_to_en($lesson->course->name)}}/lesson/{{$lesson->id}}">http://colorme.vn/resource/{{convert_vi_to_en($lesson->course->name)}}/lesson/{{$lesson->id}}</a>
                                </td>
                            </tr>
                        </table>
                    </td>
                                            ...
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="center"
                                                            style="font-family: Arial, sans-serif; color: #333333; font-size: 16px;">
                                                            <a href="http://colorme.vn/student/lessoncontent/{{$lesson->id}}">http://colorme.vn/student/lessoncontent/{{$lesson->id}}</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
