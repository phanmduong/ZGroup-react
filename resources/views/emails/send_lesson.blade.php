                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    class="padding-copy">
                                    <p>Ngày mai, {{$study_date}}, chúng ta sẽ học Buổi {{$lesson->order}}
                                        môn {{$class->course->name}} tại {{$class->classroom}}
                                        , {{$class->base->address}} nhé.</p>
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                                    style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">Chúng mình xin gửi bạn trước giáo trình Buổi {{$lesson->order}}
                                    :
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                                    style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">
                                    <a href="http://phanmduong.ml/resource/{{convert_vi_to_en($lesson->course->name)}}/lesson/{{$lesson->id}}">http://phanmduong.ml/resource/{{convert_vi_to_en($lesson->course->name)}}/lesson/{{$lesson->id}}</a>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;"
                ...
                <tr>
                    <td style="padding: 10px 0 0px 0; border-top: 1px solid #eaeaea; border-bottom: 1px dashed #aaaaaa;">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td valign="top" class="mobile-wrapper" colspan="2">
                                    <!-- LEFT COLUMN -->
                                            ...
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="center"
                                                            style="font-family: Arial, sans-serif; color: #333333; font-size: 16px; font-weight: bold;">
                                                            Link giáo trình (Bạn cần đăng nhập để xem giáo trình)
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="center"
                                                            style="font-family: Arial, sans-serif; color: #333333; font-size: 16px;">
                                                            <a href="http://phanmduong.ml/student/lessoncontent/{{$lesson->id}}">http://phanmduong.ml/student/lessoncontent/{{$lesson->id}}</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left"
                                    style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">Chúc bạn một ngày tốt lành, nhớ dành thời gian để luyện tập và
                                    làm bài tập nhé.
                                </td>
                            </tr>
                            <tr>
