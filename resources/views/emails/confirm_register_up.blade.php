<head>
    ...
    <style type="text/css">
        ...
        #goods-table, #goods-table th, #goods-table td {
                                                    ...
                                                    <tr>
                                                        <td style="padding-top: 30px;">
                                                            <table width="170" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                <tr>
                                                                    <td style="text-align: center; border-radius:30px; background-color: #96d21f; color: #ffffff; border-style:solid; border-color: #96d21f; border-width: 2px">
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <tr>
                                            <td style="padding: 20px; color: #4D5766; font-weight: 200; text-decoration:none; font-size:16px; font-family: 'nokia-pure-text-light', 'Roboto Light', Roboto, Helvetica Neue, Helvetica, sans-serif; line-height:28px;">
                                                <p>Chào {{$user->name}},</p>
                                                <p>Chúng tôi đã nhận được đăng ký của bạn, vui lòng kiểm tra thông
