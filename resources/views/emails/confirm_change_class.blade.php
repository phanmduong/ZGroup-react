                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center"
                                    ...
                                    class="padding-copy">Xác nhận đã đổi thành công từ lớp {{$oldClass->name}} sang
                                    lớp {{$newClass->name}}
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                                    style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;">{{$user->name}}
                                    thân mến,
                                </td>
                            </tr>
                            {{--<tr>--}}
                            ...
                            {{--class="padding-copy">Cám ơn bạn đã tin tưởng và lựa chọn chúng mình! ColorME hi vọng--}}
                            {{--bạn sẽ học được những điều bổ ích và có quãng thời gian tuyệt vời ở ColorME.--}}
                            ...
                            <tr>
                                <td align="left"
                                    style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">Dưới đây là thông tin về lớp học mới {{$newClass->name}} của
                                    bạn
                                </td>
                            </tr>
                        </table>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            Thông tin lớp học {{$newClass->name}}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{$newClass->course->name}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{$newClass->course->duration}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{$newClass->study_time}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{$newClass->classroom}}
                                                            - {{$newClass->base->address}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{$register->code}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <!-- COPY -->
                                <td align="center"
                                    style="font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size: 20px;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">
                                    <ul>
