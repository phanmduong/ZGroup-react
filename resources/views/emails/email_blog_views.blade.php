                        ...
                        <tbody>
                            <tr>
                                <td class="mobile-no-padding" style="padding-top: 20px; padding-right: 20px; padding-left: 20px;">
                                                ...
                                                <td class="mobile-no-radius" style="background-color:#ffffff; border-radius: 15px;">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <img class="header-image" src="{{generate_protocol_url($blog['url'])}}" border="0" alt="" title="logo" width="600" height="auto"
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding-top: 0px; padding-right: 30px; padding-left: 30px;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="text-align: center;vertical-align: middle;">
                                                                                <td style="text-align: center;background: #white">
                                                                                    <img src="{{generate_protocol_url(config('app.favicon'))}}" alt="Logo" style="margin:20px" height="45px" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="padding-top: 10px; color:#001131; font-weight: 100; text-decoration:none; font-size:36px; font-family: 'nokia-pure-headline-light', 'Roboto Light', Roboto, Helvetica Neue, Helvetica, Open sans, Arial, sans-serif; line-height:42px; text-align: center;">
                                                                                    {{$blog['author']['name']}}, bài viết của bạn đã đạt hơn {{$views}} lượt xem!
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td style="padding-top: 5px; padding-bottom: 25px">
                                                                                    <table width="170" border="0" cellpadding="0" cellspacing="0" style="margin: auto;" align="center">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="text-align: center; border-radius:30px; background-color: #114fb2; color: #ffffff; border-style:solid; border-color: #114fb2; border-width: 2px">
                                                                                                    <a href="{{url('/blog/' . $blog['slug'])}}" target="_blank" style="display:block; width:100%; font-size:14px; min-height:40px; line-height:40px; font-weight: 200; text-decoration:none; color: #ffffff; font-family: 'nokia-pure-text-light', 'Roboto Light', Roboto, Helvetica Neue, Helvetica, Open sans, Arial, sans-serif; cursor:pointer;">
                                                                                                        Xem bài viết
                                                                                                    </a>
                                                                                                </td>
                                                                                            </tr>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding-top: 40px; ; padding-right: 30px; padding-left: 30px;">
                                                                    <tbody>
                                    ...
                                    <table class="container" align="center" width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#e8e8e8">
                                        <tbody>
                                            <tr>
