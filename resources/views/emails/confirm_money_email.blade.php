                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center"
                                    ...
                                    class="padding-copy">Xác nhận thanh toán thành công khoá học {{$course->name}}
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    class="padding-copy">
                                    Chúc mừng bạn đã trở thành một thành viên của gia đình ColorME
                                    <br/>
                                    Cám ơn bạn đã tin tưởng và lựa chọn chúng mình! ColorME hi vọng
                            ...
                            <tr>
                                <td align="left"
                                    style="text-align:center;padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                    class="padding-copy">Dưới đây là một số thông tin về khoá học của bạn
                                </td>
                            </tr>
                        </table>
                    </td>
                                            ...
                                            <tr>
                                                <td style="padding: 0 0 10px 0;">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tr>
                                                            <td align="right"
                                                                style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{format_date($class->datestart)}}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{currency_vnd_format($register->money)}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="right"
                                                            style="font-family: Arial, sans-serif; color: #e53935; font-size: 16px;">{{$register->paid_time}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
