            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#e8e8e8"><tbody><tr><td class="mobile-no-padding" style="padding-top: 20px; padding-right: 20px; padding-left: 20px;">
                        <table class="container" align="center" width="600" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td class="mobile-no-radius" style="background-color:#ffffff; border-radius: 15px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td>
                                                <img class="header-image" src="http://d1j8r0kxyu9tj8.cloudfront.net/images/150804570973tDaWciEPzbng5.jpg" border="0" alt="" title="logo" width="600" height="auto" style="display: block; border-top-left-radius: 15px; border-top-right-radius: 15px;">
                                            </td></tr></tbody></table>
                                    <!--end HEADER-->
                                    <!-- BLOCK - 1 column / main -->
