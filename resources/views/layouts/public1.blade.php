...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-4"><p><!-- react-text: 209 -->Cơ sở 1<!-- /react-text --><br><!-- react-text: 211 -->
            Số 175 phố Chùa Láng - Đống Đa - Hà Nội<!-- /react-text --></p>
        <p><!-- react-text: 213 -->Cơ sở 2<!-- /react-text --><br><!-- react-text: 215 -->Số 162 phố Phương Liệt ( số 83
            Trường Chinh rẽ vào) - Thanh Xuân - Hà Nội<!-- /react-text --></p>
