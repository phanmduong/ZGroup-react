        ...
        animate: function (a, b, c, e, g, f, h) {
            ...
            if (a) {
                var b = this.creditsPosition,
                    c = a.style, e = a.offsetWidth, a = a.offsetHeight, d = 0, f = 0, h = this.realWidth,
                    k = this.realHeight, l = this.type;
    ...
    d.AmGraph = d.Class({
        ...
        setAnimationPlayed: function () {
            ...
            if (1 < a.length) {
                ...
                w && (t = w);
                var w =
                    g.fillColorsR, z = g.fillColorsSwitched;
                z && (w = z);
                var x = g.dashLength;
