...
class Pagination extends React.Component {
    ...
    render() {
        ...
        let endPage =
            5 - page.length + currentPage >= totalPages ? totalPages : 5 - page.length + currentPage;
        ...
        if (page && page.length < 5) {
            ...
            for (
                let i = page[0] - 1;
                i >= (page[0] - (5 - page.length) > 0 ? page[0] - (5 - page.length) : 1);
                i--
            ) {
                pageData = [i, ...pageData];
            }
        ...
        return (
            <ul className="pagination pagination-info float-right">
                ...
                <li className={currentPage - 1 <= 0 ? "disabled" : ""}>
                    <a
                        onClick={() => {
                            if (currentPage - 1 > 0) this.props.loadDataPage(currentPage - 1);
                        }}>
                        {" "}
                        Trước
                    </a>
...
=======
                ...
                <li className={currentPage + 1 > totalPages ? "disabled" : ""}>
                    <a
                        onClick={() => {
                            if (currentPage + 1 <= totalPages) this.props.loadDataPage(currentPage + 1);
                        }}>
                        Tiếp{" "}
                    </a>
