...
import customerServicesRootReducer from "../reducers/customerServices";
...
const store = configureStore({}, customerServicesRootReducer);
...
render(
    <Provider store={store}>
        <Router
            ...
            routes={renderRoutes(CustomerServiceRoute)}
        />
    </Provider>,
