...
class SummaryMarketingCampaignRoomContainer extends React.Component {
...
SummaryMarketingCampaignRoomContainer.propTypes = {
...
function mapStateToProps(state) {
    return {
        isLoadingGens: state.summaryMarketingCampaignRoom.isLoadingGens,
        bases: state.summaryMarketingCampaignRoom.bases,
        summary: state.summaryMarketingCampaignRoom.summary,
        isLoadingBases: state.summaryMarketingCampaignRoom.isLoadingBases,
        isLoading: state.summaryMarketingCampaignRoom.isLoading,
    };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(SummaryMarketingCampaignRoomContainer);
