...
export function loadGoods(type = null, page, search) {
    return function(dispatch) {
        ...
        goodApi.loadGoods(type, page, search).then(res => {
            dispatch({
...
export function uploadAvatar(file) {
    return function(dispatch) {
        ...
        goodApi.uploadAvatar(file, completeHandler, progressHandler, error);
    };
}
...
export function loadGood(goodId) {
    return function(dispatch) {
        ...
        goodApi.loadGood(goodId).then(res => {
            dispatch({
...
export const duplicateProperty = (propertyId, cb) => {
    return dispatch => {
        dispatch({
            type: types.BEGIN_LOAD_GOOD_PROPERTY_ITEMS,
        });
        goodApi.duplicateGoodProperty(propertyId).then(() => {
            cb();
        });
    };
};
...
export function saveGoodProperty(property, type) {
    return function(dispatch) {
        ...
        goodApi.saveGoodProperty(property).then(res => {
...
export function loadGoodPropertyItem(id) {
    return function(dispatch) {
        ...
        goodApi.loadGoodPropertyItem(id).then(res => {
...
export function loadAllGoodPropertyItems(type, taskId) {
    return function(dispatch) {
        ...
        return new Promise(resolve => {
            goodApi.loadAllGoodPropertyItems(type, taskId).then(res => {
...
export function loadGoodPropertiesFilled(cardId, goodProperties) {
    return function(dispatch) {
        ...
        goodApi.loadGoodPropertiesFilled(cardId, goodProperties).then(res => {
            dispatch({
