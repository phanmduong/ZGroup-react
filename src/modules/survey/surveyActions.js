import {
    ...
    UPDATE_SURVEY_DATA_IN_LIST, TOGGLE_SUMMARY_SURVEY_MODAL,TOGGLE_OVERVIEW_SURVEY_MODAL
} from '../../constants/actionTypes';
import * as surveyApi from './surveyApi';
import {showErrorMessage, showNotification} from "../../helpers/helper";

export const toggleOverviewModal = (showOverviewModal) => {
    return (dispatch) => {
        dispatch({
            type: TOGGLE_OVERVIEW_SURVEY_MODAL,
            showOverviewModal
        });
    };
};
