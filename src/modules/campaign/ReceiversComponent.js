            ...
            <div className="campaign-content">
                <div className="form-group is-empty">
                    ...
                    <input
                        ...
                        type="search" className="form-control" placeholder="Tìm kiếm tin nhắn" value=""/>
                </div>
                <br/><br/><br/>
                <div className="table-responsive">
                    <table className="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <span style={{width:"120"}}>01626457547</span>
                                &ensp;
                                <span>
                                    <img style={{height: "20"}}
                            ...
                            <td>
                                <OverlappedCircles
                                    circles={[
                                        "http://i.9mobi.vn/cf/images/2015/03/nkk/anh-dep-6.jpg",
                                        "https://yugo.vn/wp-content/uploads/2017/11/hinh-nen-tinh-yeu-dep.png",
                                        "https://yugo.vn/wp-content/uploads/2017/11/hinh-nen-tinh-yeu-dep.png",
                                    ]}
                                />
                            </td>
                                ...
                                <div className="btn-group-action">
                                    <div style={{display: "inline-block"}}>
                                        <a data-toggle="tooltip" title="" type="button" rel="tooltip"
                                           data-original-title="Xem chi tiết"><i className="material-icons">add_circle</i>
                                        </a>
                                    </div>
