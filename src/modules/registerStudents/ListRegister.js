                ...
                <table className="table">
                    ...
                    {this.props.registers.map((register) => {
                        return (
                            ...
                            <td>{register.name}</td>
                            <td><div style={{width:'100px', wordBreak: 'break-all'}} data-toggle="tooltip" title="" type="button" rel="tooltip"
                                     data-original-title={register.email}>{register.email}</div></td>
                            ...
                            <td>
                                <h6>{register.paid_status ? register.money + '/' + register.course_money : 'Chưa nộp'}</h6>
