                    ...
                    <div className="row" style={{marginTop: '10px', marginBottom: '10px'}}>
                        <div className="col-md-12">
                            <ul className="nav nav-pills nav-pills-rose">
                                <li className={this.path === `/marketing/sales-room` ? 'active' : ''}>
                                    <IndexLink to={`/marketing/sales-room`}>Tổng quan</IndexLink>
                                </li>
                                <li className={this.path === `/marketing/sales-room/statistic` ? 'active' : ''}>
                                    <Link to={`/marketing/sales-room/statistic`}>Thống kê</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
