                            ...
                            <div className="panel panel-default">
                                <div className="panel-heading" role="tab" id={'headingCollectMoneyUser' + user.id}>
                                    <a role="button" data-toggle="collapse" data-parent="#accordion"
                                       ...
                                       aria-expanded="false" aria-controls={'collectMoneyUser' + user.id}
                                       className="collapsed"
                                    >
                                ...
                                <div id={'collectMoneyUser' + user.id} className="panel-collapse collapse"
                                     role="tabpanel"
                                     aria-labelledby={'headingCollectMoneyUser' + user.id} aria-expanded="false"
                                     style={{height: '0px'}}>
