...
class SubscribersContainer extends React.Component {
    constructor(props, context) {
        ...
        this.updateFormDataSubscriber = this.updateFormDataSubscriber.bind(this);
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.subscribersListItem.id != this.props.subscribersListItem.id) {
            this.setState({
    ...
    storeSubscribersList() {
        ...
        if ($("#form-edit-email").valid()) {
            this.props.emailSubscribersListActions.storeSubscribersList(this.state.subscribersList);
        }
    }
    ...
    uploadFile() {
        ...
        this.props.emailSubscribersListActions.uploadFileSubscribers(this.listId, this.state.file, this.closeModalUpFile);
    }
                    ...
                    <div className="row">
                        <div className="col-md-8">
                            <div className="card">
                                ...
                                {this.props.subscribersListItem.id || this.props.isLoadingSubscribersListItem || this.props.isLoading ?
                                    (
                                        <div>
                        ...
                        <div className="col-md-4">
                            <div className="card">
                                ...
                                <div className="card-content">
                                    ...
                                    {
                                        this.props.isLoadingSubscribersListItem ? <Loading/> :
                                                    ...
                                                    this.props.isStoring ?
                                                        (
                                                            ...
                                                            >
                                                                ...
                                                                {this.listId ? ' Đang cập nhật' : ' Đang tạo'}
                                                            </button>
                                                        )
                                                        :
                                                        <button
...
function mapStateToProps(state) {
    return {
        ...
        isLoadingSubscribersListItem: state.emailSubscribersList.isLoadingSubscribersListItem,
