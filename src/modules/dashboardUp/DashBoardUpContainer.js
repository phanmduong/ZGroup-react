...
class DashBoardUpContainer extends React.Component {
    ...
    componentWillMount() {
        this.props.dashboardActions.loadBases();
        this.props.dashboardActions.loadRooms();
    }

    loadSeats(from, to, roomId) {
        this.props.dashboardActions.loadSeats(from, to, roomId);
    }
    ...
    onchangeBase(value) {
        ...
        if (value === 0) this.props.dashboardActions.loadRooms();
        else this.props.dashboardActions.loadRooms(value);
    }
    ...
    render() {
        return (
            <div>
                {this.props.isLoadingBases || this.props.isLoadingRooms ? (
                    <Loading />
                ) : (
                    <div>
                        <div className="row">
