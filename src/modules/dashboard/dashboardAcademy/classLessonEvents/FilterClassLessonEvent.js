...
import filterExamStore from "./filterClassLessonEventStore";
...
@observer
class FilterClassLessonEvent extends React.Component {
...
FilterClassLessonEvent.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(FilterClassLessonEvent);
