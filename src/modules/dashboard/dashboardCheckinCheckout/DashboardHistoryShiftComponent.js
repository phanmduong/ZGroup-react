...
import DashboardHistoryShiftStore from "./DashboardHistoryShiftStore";

@observer
class DashboardHistoryShiftComponent extends React.Component {
    constructor(props, context) {
        super(props, context);
        this.store = new DashboardHistoryShiftStore();
    }
    ...
    render() {
        const {isLoading, shifts} = this.store;
        return (
            <div>
                                                            ...
                                                            <tr key={employee.id}>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        {_.orderBy(employee.shifts, ["id"]).map((shift) => {
...
export default DashboardHistoryShiftComponent;
