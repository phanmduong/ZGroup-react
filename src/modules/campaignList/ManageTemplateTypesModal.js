...
class ManageTemplateTypesModal extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.isSavingTemplateTypes !== this.props.isSavingTemplateTypes
    ...
    render() {
        let first = this.props.totalCountTemplateTypes ? (this.props.currentPageTemplateTypes - 1) * this.props.limitTemplateTypes + 1 : 0;
        let end = this.props.currentPageTemplateTypes < this.props.totalPagesTemplateTypes ? this.props.currentPageTemplateTypes * this.props.limitTemplateTypes : this.props.totalCountTemplateTypes;
        return (
            <Modal show={this.props.manageTemplateTypesModal}
                ...
                <Modal.Body>
                    <Modal show={this.state.modal}
                        ...
                        <a onClick={() => this.setState({modal: false})}
                           id="btn-close-modal"/>
                        <Modal.Header closeButton>
                            <Modal.Title id="contained-modal-title">{this.state.id ? "Sửa" : "Thêm"}</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <div className="row">
                        ...
                        this.props.isLoadingTemplateTypes ? (
                            ...
                            <div className="table-responsive">
                                <table className="table table-hover">
                                    ...
                                    <tbody>
                                    {
                                        this.props.templateTypesList && this.props.templateTypesList.map((type, id) => {
                                            return (
                                                <tr key={id}>
                                                    <td>
                                                        <span className="text-name-student-register"
                                                              rel="tooltip" title="">
                                                            {type.name}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <div className="campaign-message-type"
                    ...
                    <div style={{textAlign: 'right'}}>
                        <b style={{marginRight: '15px'}}>
                            ...
                            - {end}/{this.props.totalCountTemplateTypes}</b><br/>
                        <Pagination
