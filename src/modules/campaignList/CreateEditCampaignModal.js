...
class CreateEditCampaignModal extends React.Component {
	...
	render() {
		...
		return (
			<Modal
				show={this.props.createEditCampaignModal}
				onHide={() => this.props.campaignListAction.showCreateEditCampaignModal()}
			>
				<a onClick={() => this.props.campaignListAction.showCreateEditCampaignModal()} id="btn-close-modal" />
					...
					<div className="form-group">
						<form role="form" id="form-add-room">
							...
							<div className="form-group">
								...
								<Switch onChange={this.handleCampaignStatus} value={campaign.status === 'open'} />
							</div>
