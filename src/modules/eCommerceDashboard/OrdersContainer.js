...
class OrdersContainer extends React.Component {
    ...
    updateFormDate(event) {
        ...
        if (
            !helper.isEmptyInput(time.startTime) &&
            !helper.isEmptyInput(time.endTime)
        ) {
                                            ...
                                            <div className="row">
                                                <div className="form-group col-md-4">
                                                    ...
                                                    <Select
                                                        ...
                                                        options={this.props.allStaffs.map(
                                                            staff => {
                                                                return {
                                                                    ...staff,
                                                                    value:
